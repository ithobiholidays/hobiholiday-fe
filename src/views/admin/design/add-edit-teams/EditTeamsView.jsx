...
const EditTeamsView = ({ params }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await updateData("/team/edit", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });

      showToast({ message: "Successfully Edit Team", type: "success" });
  ...
  const fetchPost = async () => {
    try {
      const response = await getPost(`/team/${params.id}`);
