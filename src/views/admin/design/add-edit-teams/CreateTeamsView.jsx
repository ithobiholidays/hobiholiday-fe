...
const CreateTeamsView = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await postData("/team/add", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });

      showToast({ message: "Successfully Created Team", type: "success" });

      router.push("/dashboard/design/add-edit-teams");
    } catch (error) {
  ...
  return (
    <div>
      <div className="flex gap-10 items-center">
        <p className="text-3xl font-medium">Add New Team</p>
...
export default CreateTeamsView;
