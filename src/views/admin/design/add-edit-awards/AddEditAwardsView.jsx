...
const paths = [
  ...
  {
    title: "Add Edit Award",
    href: "/",
  },
];

const AddEditAwardsView = () => {
      ...
      render: (row) => (
        <div className="flex gap-2">
          <Link
            ...
            href={`/dashboard/design/add-edit-awards/${row?.id}`}
          >
            <MdOutlineEdit />
            Edit
          </Link>
  ...
  return (
    <div>
      <div className="flex gap-10 items-center">
        <p className="text-3xl font-medium">Add/Edit Award</p>
      ...
      <div className="flex justify-between items-center mt-8">
        <CustomButton
          onClick={() =>
            router.push("/dashboard/design/add-edit-awards/create")
          }
        >
          Add New Award
        </CustomButton>
...
export default AddEditAwardsView;
