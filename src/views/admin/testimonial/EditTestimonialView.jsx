...
const EditTestimonyView = ({ params }) => {
  ...
  const onSubmit = async (data) => {
    try {
      await updateData("/testi/edit", data);
  ...
  const fetchPost = async () => {
    try {
      const response = await getTestimony(`/testi/${params.id}`);
