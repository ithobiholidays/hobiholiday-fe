...
import CategoriesPackageModal from "./component/CategoriesPackageModal";
...
const paths = [
  ...
  {
    title: "Tour Packages",
    href: "/dashboard/tour-packages/categories",
  },
  {
...
const CategoriesPackageView = () => {
  ...
  const columns = [
    ...
    { key: "productCount", label: "No Of Post" },
    {
      key: "actions",
      label: "Action",
      render: (row) => (
  ...
  const fetchData = async () => {
    try {
      await postData(`/category/alls?q=${searchValue}`, {
        p: page,
        limit: perPage,
      });
    } catch (error) {
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mt-8">
        <CustomButton onClick={onOpen}>Add New Package</CustomButton>
...
export default CategoriesPackageView;
